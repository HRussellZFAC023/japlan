...
TIME_WINDOWS: List[Tuple[str, time]] = [
    ("Pre-Dawn (05:00-06:30)", time(5, 0)),
    ("Early Morning (06:00-08:00)", time(6, 0)),
    ("Morning (08:00-10:00)", time(8, 0)),
    ("Late Morning (10:00-12:00)", time(10, 0)),
    ("Lunch (12:00-13:30)", time(12, 0)),
    ("Early Afternoon (13:30-15:00)", time(13, 30)),
    ("Afternoon (15:00-17:00)", time(15, 0)),
    ("Late Afternoon (16:00-18:00)", time(16, 0)),
    ("Evening (17:00-19:00)", time(17, 0)),
    ("Dinner (19:00-21:00)", time(19, 0)),
    ("Night (21:00-23:00)", time(21, 0)),
    ("Late Night (23:00-00:30)", time(23, 0)),
    ("Full Day (08:00-20:00)", time(8, 0)),
]

TIME_WINDOW_START: Dict[str, time] = {label: start for label, start in TIME_WINDOWS}
TIME_WINDOW_ORDER: Dict[str, int] = {label: idx for idx, (label, _start) in enumerate(TIME_WINDOWS)}

MANUAL_DAY_META: Dict[int, Dict[str, object]] = {
    1: {"title": "Touchdown & cosy Hirakata welcome", "friends": ["Henry", "Nanako"]},
    2: {"title": "Osaka Minami street fashion & neon bites", "friends": ["Henry", "Nanako"]},
    3: {"title": "Osaka Castle glow & Umeda skyline", "friends": ["Henry", "Nanako"]},
    4: {"title": "Kyoto riverside & shrine symphony", "friends": ["Henry", "Nanako"]},
    5: {"title": "Hirakata co-work rhythm & cosy comforts", "friends": ["Henry", "Nanako"]},
    6: {"title": "Mount Koya retreat & temple night", "friends": ["Henry", "Nanako"]},
    7: {"title": "Return to Osaka & bayfront sparkle", "friends": ["Henry", "Nanako"]},
    8: {"title": "Work sprint & shinkansen to Shibuya", "friends": ["Henry", "Nanako", "Nicole", "Ken"]},
    9: {"title": "Tokyo DisneySea sparkle with the crew", "friends": ["Henry", "Nanako", "Nicole", "Ken"]},
    10: {"title": "Toyosu mornings & Odaiba glow", "friends": ["Henry", "Nanako", "Nicole", "Ken"]},
    11: {"title": "Harajuku vibes & skyline toasts", "friends": ["Henry", "Nanako", "Nicole", "Ken", "James", "Phil"]},
    12: {"title": "Asakusa sunrise & Osaka return reset", "friends": ["Henry", "Nanako"]},
    13: {"title": "Creative Osaka reset & Kaiyukan night", "friends": ["Henry", "Nanako"]},
    14: {"title": "Himeji heritage & Kobe indulgence", "friends": ["Henry", "Nanako"]},
    15: {"title": "Osaka birthday supernova", "friends": ["Henry", "Nanako", "Nicole", "Ken"]},
    16: {"title": "Kyoto foliage encore with friends", "friends": ["Henry", "Nanako", "Nicole", "Ken"]},
    17: {"title": "Osaka soft landing & farewell", "friends": ["Henry", "Nanako"]},
}
...
MANUAL_DAY_SCHEDULE: Dict[int, List[Dict[str, object]]] = {
    1: [
        ...
        {
            "label": "Agora Riverside Base",
            "time": "Late Afternoon (16:00-18:00)",
            "stops": [{"name": "Hotel Agora Osaka Moriguchi"}],
        },
        {
            "label": "Hirakata Local Day",
            "time": "Dinner (19:00-21:00)",
            "stops": [{"name": "Torisei Hirakata"}],
        },
    ],
    2: [
        {
            "label": "Brooklyn Roasting Break",
            "time": "Morning (08:00-10:00)",
            "stops": [{"name": "Brooklyn Roasting Company"}],
        },
        {
            "label": "Shinsaibashi-Suji Stroll",
            "time": "Late Morning (10:00-12:00)",
            "stops": [{"name": "Shinsaibashi-Suji Shopping Street"}],
        },
        {
            "label": "Kuromon Market Crawl",
            "time": "Lunch (12:00-13:30)",
            "stops": [{"name": "Kuromon Market"}],
        },
        {
            "label": "Namba Yasaka Jinja",
            "time": "Early Afternoon (13:30-15:00)",
            "stops": [{"name": "Namba Yasaka Jinja"}],
        },
        {
            "label": "Osaka Minami Street Food",
            "time": "Afternoon (15:00-17:00)",
            "stops": [{"name": "Dotonbori"}],
        },
        {
            "label": "Osaka Minami Street Food",
            "time": "Evening (17:00-19:00)",
            "stops": [{"name": "Tombori River Cruise"}],
        },
        {
            "label": "Osaka Minami Street Food",
            "time": "Dinner (19:00-21:00)",
        ...
        {
            "label": "Nagai Night Lights",
            "time": "Night (21:00-23:00)",
            "stops": [{"name": "teamLab Botanical Garden"}],
        },
    ],
    3: [
        {
            "label": "Osaka Castle Morning",
            "time": "Morning (08:00-10:00)",
            "stops": [{"name": "Osaka Castle"}],
        },
        {
            "label": "Osaka Castle Morning",
            "time": "Late Morning (10:00-12:00)",
            "stops": [{"name": "& COFFEE MAISON"}],
        },
        {
            "label": "Osaka Museum of Housing",
            "time": "Early Afternoon (13:30-15:00)",
            "stops": [{"name": "Osaka Museum of Housing and Living"}],
        },
        {
            "label": "Umeda Skylines",
            "time": "Afternoon (15:00-17:00)",
            "stops": [{"name": "Grand Front Osaka"}],
        },
        {
            "label": "Umeda Skylines",
            "time": "Late Afternoon (16:00-18:00)",
            "stops": [{"name": "Umeda Sky Building"}],
        },
        {
            "label": "Nakazakicho Ramen",
            "time": "Dinner (19:00-21:00)",
            "stops": [{"name": "Human Beings Everybody Noodles"}],
        },
    ],
    4: [
        {
            "label": "Arashiyama Day Circuit",
            "time": "Pre-Dawn (05:00-06:30)",
            "stops": [{"name": "Arashiyama Bamboo Forest"}],
        },
        {
            "label": "Arashiyama Day Circuit",
            "time": "Morning (08:00-10:00)",
            "stops": [{"name": "Tenryu-ji"}],
        },
        {
            "label": "Arashiyama Riverside Lunch",
            "time": "Late Morning (10:00-12:00)",
            "stops": [{"name": "Arashiyama Yoshimura"}],
        },
        {
            "label": "Arashiyama Day Circuit",
            "time": "Early Afternoon (13:30-15:00)",
            "stops": [{"name": "Kimono Forest"}],
        },
        {
            "label": "Fushimi Sunset Gates",
            "time": "Afternoon (15:00-17:00)",
            "stops": [{"name": "Fushimi Inari Taisha"}],
        },
        {
            "label": "Fushimi Sake Cellar",
            "time": "Late Afternoon (16:00-18:00)",
            "stops": [{"name": "Gekkeikan Okura Sake Museum"}],
        },
        {
            "label": "Tsuen Tea",
            "time": "Evening (17:00-19:00)",
            "stops": [{"name": "Tsuen Tea"}],
        },
        {
            "label": "Kyoto Yakiniku Hiro",
            "time": "Dinner (19:00-21:00)",
            "stops": [{"name": "Kyoto Yakiniku Hiro"}],
        },
        {
            "label": "Pontocho Alley",
            "time": "Night (21:00-23:00)",
            "stops": [{"name": "Pontocho Alley"}],
        },
    ],
    5: [
        {
            "label": "Hirakata Local Day",
            "time": "Lunch (12:00-13:30)",
            "stops": [{"name": "Café & Meal MUJI"}],
        },
        {
            "label": "Bear Paw Cafe Break",
            "time": "Early Afternoon (13:30-15:00)",
            "stops": [{"name": "Bear Paw Cafe"}],
        },
        {
            "label": "Hirakata Wellness Break",
            "time": "Late Afternoon (16:00-18:00)",
            "stops": [{"name": "Gokurakuyu Hirakata"}],
        },
        {
            "label": "Hirakata Local Day",
            "time": "Dinner (19:00-21:00)",
            "stops": [{"name": "Kushikatsu Tanaka"}],
        },
        {
            "label": "Kuzuha Mall Late Run",
            "time": "Night (21:00-23:00)",
            "stops": [{"name": "Kuzuha Mall"}],
        },
    ],
    6: [
        {
            "label": "Koyasan Ropeway Ascent",
            "time": "Morning (08:00-10:00)",
            "stops": [{"name": "Namba to Koyasan"}],
        },
        {
            "label": "Koyasan Temple Tour",
            "time": "Late Morning (10:00-12:00)",
            "stops": [{"name": "Kongobu-ji"}],
        },
        {
            "label": "Eko-in Temple Stay",
            "time": "Late Afternoon (16:00-18:00)",
            "stops": [{"name": "Eko-in Temple"}],
        },
        {
            "label": "Okunoin Night Walk",
            "time": "Night (21:00-23:00)",
            "stops": [{"name": "Okunoin"}],
        },
    ],
    7: [
        {
            "label": "OMO7 Osaka Stay",
            "time": "Afternoon (15:00-17:00)",
            "stops": [{"name": "OMO7 Osaka"}],
        },
        {
            "label": "Kaiyukan Twilight Wander",
            "time": "Late Afternoon (16:00-18:00)",
            "stops": [{"name": "Osaka Aquarium Kaiyukan"}],
        },
        {
            "label": "Tempozan Marketplace Stroll",
            "time": "Evening (18:00-20:00)",
            "stops": [{"name": "Tempozan Marketplace"}],
        },
    ],
    8: [
        {
            "label": "Osaka Sweet Cravings",
            "time": "Morning (08:00-10:00)",
            "stops": [{"name": "Masahiko Ozumi Paris"}],
        },
        {
            "label": "Nozomi Northbound",
            "time": "Early Afternoon (13:30-15:00)",
            "stops": [{"name": "Nozomi Express"}],
        },
        {
            "label": "Sequence Miyashita Park",
            "time": "Late Afternoon (15:00-17:00)",
            "stops": [{"name": "sequence MIYASHITA PARK"}],
        },
        {
            "label": "Shibuya Night Circuit",
            "time": "Late Afternoon (16:00-18:00)",
            "stops": [
        ...
        },
        {
            "label": "Shibuya Night Circuit",
            "time": "Dinner (19:00-21:00)",
            "stops": [{"name": "Kaikaya by the Sea"}],
        },
    ],
    9: [
        {
            "label": "Tokyo DisneySea Day",
            "time": "Full Day (08:00-20:00)",
            "stops": [{"name": "Tokyo DisneySea"}],
        },
        {
            "label": "Disney Hotel Tea",
            "time": "Afternoon (15:00-17:00)",
            "stops": [{"name": "Disney Hotel"}],
        },
        {
            "label": "MIMARU Tokyo Base",
            "time": "Night (21:00-23:00)",
            "stops": [{"name": "MIMARU Tokyo Shinjuku WEST"}],
        },
    ],
    10: [
        {
            "label": "Toyosu Morning & teamLab",
            "time": "Early Morning (06:00-08:00)",
            "stops": [{"name": "Toyosu Market"}],
        },
        {
            "label": "Toyosu Morning & teamLab",
            "time": "Morning (08:00-10:00)",
            "stops": [{"name": "teamLab Planets"}],
        },
        {
            "label": "Pokémon Cafe",
            "time": "Lunch (12:00-13:30)",
            "stops": [{"name": "Pokémon Café"}],
        },
        {
            "label": "Odaiba Seaside",
            "time": "Early Afternoon (13:30-15:00)",
            "stops": [{"name": "Odaiba Seaside Park"}],
        },
        {
            "label": "Maidreamin Akihabara",
            "time": "Late Afternoon (16:00-18:00)",
            "stops": [{"name": "Maidreamin Akihabara"}],
        },
        {
            "label": "Karaoke Night Shibuya",
            "time": "Evening (17:00-19:00)",
            "stops": [{"name": "Karaoke Kan Shibuya"}],
        },
        {
            "label": "Ichiran Late Ramen",
            "time": "Night (21:00-23:00)",
            "stops": [{"name": "Ichiran Ramen"}],
        },
    ],
    11: [
        {
            "label": "Meiji Forest Walk",
            "time": "Morning (08:00-10:00)",
            "stops": [{"name": "Meiji Jingu"}],
        },
        {
            "label": "Harajuku Street Mix",
            "time": "Late Morning (10:00-12:00)",
            "stops": [{"name": "Takeshita Street"}],
        },
        {
            "label": "Harajuku Street Mix",
            "time": "Lunch (12:00-13:30)",
        ...
        },
        {
            "label": "Harajuku Street Mix",
            "time": "Early Afternoon (13:30-15:00)",
            "stops": [{"name": "Cat Street"}],
        },
        {
            "label": "Daikanyama Stroll",
            "time": "Afternoon (15:00-17:00)",
            "stops": [{"name": "Daikanyama T-Site"}],
        },
        {
            "label": "Daikanyama Stroll",
            "time": "Late Afternoon (16:00-18:00)",
            "stops": [{"name": "Nakameguro"}],
        },
        {
            "label": "Shibuya Night Circuit",
            "time": "Evening (17:00-19:00)",
            "stops": [{"name": "Shibuya Sky"}],
        },
        {
            "label": "Gonpachi Dinner",
            "time": "Dinner (19:00-21:00)",
            "stops": [{"name": "Gonpachi Shibuya"}],
        },
    ],
    12: [
        {
            "label": "Asakusa Sunrise",
            "time": "Early Morning (06:00-08:00)",
            "stops": [{"name": "Senso-ji"}],
        },
        {
            "label": "Tokyo Skytree Deck",
            "time": "Morning (08:00-10:00)",
            "stops": [{"name": "Tokyo Skytree"}],
        },
        {
            "label": "Asakusa Sunrise",
            "time": "Lunch (12:00-13:30)",
            "stops": [{"name": "Asakusaimahan"}],
        },
        {
            "label": "Tokyo Character Street",
            "time": "Early Afternoon (13:30-15:00)",
            "stops": [{"name": "Tokyo Character Street"}],
        },
        {
            "label": "Nozomi Southbound",
            "time": "Late Afternoon (16:00-18:00)",
            "stops": [{"name": "Nozomi Express"}],
        },
        {
            "label": "Torame Yokocho Night Bites",
            "time": "Evening (17:00-19:00)",
            "stops": [{"name": "Torame Yokocho"}],
        },
    ],
    13: [
        {
            "label": "Osaka Station Sky Garden",
            "time": "Late Morning (10:00-12:00)",
            "stops": [{"name": "Osaka Station City"}],
        },
        {
            "label": "Shinsekai Retro Stroll",
            "time": "Afternoon (15:00-17:00)",
            "stops": [{"name": "Shinsekai"}],
        },
        {
            "label": "Nagai Night Lights",
        ...
        {
            "label": "Takoume Late Dinner",
            "time": "Night (21:00-23:00)",
            "stops": [{"name": "Takoume Honten"}],
        },
    ],
    14: [
        {
            "label": "Himeji Heritage Walk",
            "time": "Morning (08:00-10:00)",
            "stops": [{"name": "Himeji Castle"}],
        },
        {
            "label": "Kobe Herb View",
            "time": "Late Morning (10:00-12:00)",
            "stops": [{"name": "Kobe Nunobiki Herb Gardens"}],
        },
        {
            "label": "Steakland Kobe Lunch",
            "time": "Lunch (12:00-13:30)",
            "stops": [{"name": "Steakland Kobe"}],
        },
        {
            "label": "Arima Onsen Retreat",
            "time": "Afternoon (15:00-17:00)",
            "stops": [{"name": "Arima Onsen Taiko-no-yu"}],
        },
        {
            "label": "Kobe Harbor Nights",
            "time": "Evening (18:00-20:00)",
            "stops": [{"name": "Kobe Harborland"}],
        },
    ],
    15: [
        {
            "label": "W Osaka Birthday Core",
            "time": "Afternoon (13:00-15:00)",
            "stops": [{"name": "W Osaka"}],
        },
        {
            "label": "Afternoon Glam & Restock",
            "time": "Afternoon (15:00-17:00)",
            "stops": [
        ...
        {
            "label": "MYDO Teppanyaki Feast",
            "time": "Evening (18:00-20:00)",
            "stops": [{"name": "MYDO Teppanyaki"}],
        },
        {
            "label": "Karaoke Kan Shinsaibashi",
            "time": "Night (21:00-23:00)",
            "stops": [{"name": "Karaoke Kan Shinsaibashi"}],
        },
        {
            "label": "Bar Nayuta Rooftop",
            "time": "Late Night (23:00-00:30)",
            "stops": [{"name": "Bar Nayuta"}],
        },
    ],
    16: [
        {
            "label": "Okutan Nanzenji Lunch",
            "time": "Morning (08:00-10:00)",
            "stops": [{"name": "Eikan-dō Zenrin-ji"}],
        },
        {
            "label": "Philosopher's Path",
            "time": "Late Morning (10:00-12:00)",
            "stops": [{"name": "Philosopher's Path"}],
        },
        {
            "label": "Okutan Nanzenji Lunch",
            "time": "Lunch (12:00-13:30)",
            "stops": [{"name": "Okutan Nanzenji"}],
        },
        {
            "label": "Shizen Flower Ice Cream",
            "time": "Early Afternoon (13:30-15:00)",
            "stops": [
                {"name": "(THISIS)SHIZEN"},
                {"name": "MACCHA HOUSE Kyoto Kawaramachi"},
            ],
        },
        {
            "label": "Tōfuku-ji Canopies",
            "time": "Afternoon (15:00-17:00)",
            "stops": [{"name": "Tōfuku-ji"}],
        },
        {
            "label": "Kōdai-ji",
            "time": "Evening (17:00-19:00)",
    ...
    17: [
        {
            "label": "Takamura Farewell Brunch",
            "time": "Late Morning (10:00-12:00)",
            "stops": [{"name": "Takamura Wine & Coffee"}],
        },
        {
            "label": "Rinku Premium Outlets",
            "time": "Afternoon (13:30-15:00)",
            "stops": [{"name": "Rinku Premium Outlets"}],
        },
        {
            "label": "KIX Departure",
            "time": "Evening (17:00-19:00)",
            "stops": [{"name": "Kansai International Airport 23:10 KIX → DXB (EK317)"}],
        },
    ],
}
...
def resolve_manual_cluster_label(
    label: str, cluster_pool: Dict[str, List[Place]], canonical_map: Dict[str, str]
) -> Optional[str]:
    target = LABEL_ALIASES.get(label, label)
    if target in cluster_pool:
        return target
    canonical_target = canonical(target)
    if canonical_target in canonical_map:
        resolved = canonical_map[canonical_target]
        if resolved in cluster_pool:
            return resolved
    for key in cluster_pool.keys():
        if canonical(key) == canonical_target:
            return key
    return None


def schedule_places_manual(places: List[Place], clusters: List[Cluster]) -> List[DaySummary]:
    cluster_pool: Dict[str, List[Place]] = {}
    canonical_map: Dict[str, str] = {}
    for cluster in clusters:
        members = sorted(cluster.members, key=lambda place: place.index)
        cluster_pool[cluster.label] = members[:]
        canonical_map[canonical(cluster.label)] = cluster.label
        for alias, actual in LABEL_ALIASES.items():
            if canonical(actual) == canonical(cluster.label):
                canonical_map[canonical(alias)] = cluster.label

    name_lookup: Dict[str, Place] = {canonical(place.name): place for place in places}
    day_summaries: List[DaySummary] = []

    for day_index in sorted(MANUAL_DAY_SCHEDULE.keys()):
        entries = MANUAL_DAY_SCHEDULE.get(day_index, [])
        meta = MANUAL_DAY_META.get(day_index, {})
        day_date = BASE_DATE + timedelta(days=day_index - 1)
        summary_clusters: List[str] = []
        summary_stops: List[str] = []

        for entry in entries:
            entry_label = entry.get("label", "")
            resolved_label = resolve_manual_cluster_label(entry_label, cluster_pool, canonical_map)
            if not resolved_label:
                continue

            available = cluster_pool.setdefault(resolved_label, [])
            selected: List[Place] = []
            stop_specs = entry.get("stops")

            if stop_specs:
                for stop in stop_specs:
                    ...
                    for idx, candidate in enumerate(list(available)):
                        if canonical(candidate.name) == canonical_name and candidate.day_index is None:
                            place = candidate
                            available.pop(idx)
                            break
                    if place is None:
                        candidate = name_lookup.get(canonical_name)
                        if candidate and candidate.day_index is None:
                            pool_list = cluster_pool.setdefault(candidate.cluster_label, [])
                            if candidate in pool_list:
                                pool_list.remove(candidate)
                            place = candidate
                    if place:
                        selected.append(place)
            else:
                for candidate in list(available):
                    if candidate.day_index is None:
                        selected.append(candidate)
                cluster_pool[resolved_label] = []

            if not selected:
                continue

            if resolved_label not in summary_clusters:
                summary_clusters.append(resolved_label)

            time_label = entry.get("time", "Morning (08:00-10:00)")
            start_time = TIME_WINDOW_START.get(time_label, TIME_WINDOW_START.get("Morning (08:00-10:00)", time(8, 0)))
            assignment_time = datetime.combine(day_date, start_time)
            is_flex_entry = bool(entry.get("flex")) or resolved_label in FLEX_LABELS

            for place in selected:
                if not place.cluster_label:
                    place.cluster_label = resolved_label
                place.day_index = day_index
                place.assigned_time = assignment_time
                place.time_window = time_label
                place.is_flex = is_flex_entry or place.cluster_label in FLEX_LABELS
                summary_stops.append(place.name)

        day_title = meta.get("title", f"Day {day_index}")
...
def schedule_places_auto(places: List[Place], clusters: List[Cluster]) -> List[DaySummary]:
...
def schedule_places(places: List[Place], clusters: List[Cluster]) -> List[DaySummary]:
    if MANUAL_DAY_SCHEDULE:
        return schedule_places_manual(places, clusters)
    return schedule_places_auto(places, clusters)
...
def apply_itinerary(rows: List[Dict[str, str]]) -> Tuple[List[Dict[str, str]], List[Cluster], List[DaySummary]]:
    ...
    if MANUAL_DAY_SCHEDULE:
        day_to_friends: Dict[int, List[str]] = {
            day: list(meta.get("friends", ["Henry"])) for day, meta in MANUAL_DAY_META.items()
        }
    else:
        day_to_friends = {blueprint.day: list(blueprint.friends) for blueprint in DAY_BLUEPRINTS}

    for row in rows:
        for field in ("Date", "Day", "Weekday", "Friends", "Cluster", "Time"):
            if field in row:
                row[field] = ""
    ...
    for place in places:
        ...
        if place.time_window:
            row["Time"] = place.time_window
