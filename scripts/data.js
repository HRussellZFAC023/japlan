...
export const DEFAULT_TRIP_TEMPLATE = {
  ...
  mapPlaces: {
    dotonbori: { query: 'Dotonbori, Osaka' },
    umedaSky: { query: 'Umeda Sky Building' },
    abenoHarukas: { query: 'Abeno Harukas 300' },
    midosujiIllumination: { query: 'Midosuji Illumination Osaka' },
    arashiyama: { query: 'Arashiyama Bamboo Grove' },
    kiyomizudera: { query: 'Kiyomizu-dera Temple' },
    fushimiInari: { query: 'Fushimi Inari Taisha' },
    uji: { query: 'Byodoin Temple' },
    naraPark: { query: 'Nara Park' },
    okunoin: { query: 'Okunoin Cemetery Koyasan' },
    eikando: { query: 'Eikando Zenrinji Temple' },
    rurikoin: { query: 'Rurikoin Temple' },
    arimaOnsen: { query: 'Arima Onsen' },
    harborland: { query: 'Kobe Harborland' },
    himejiCastle: { query: 'Himeji Castle' },
    disneyResort: { query: 'Tokyo Disney Resort' },
    teamlabPlanets: { query: 'teamLab Planets TOKYO' },
    ghibliMuseum: { query: 'Ghibli Museum Mitaka' },
    shibuyaParco: { query: 'Shibuya PARCO' },
    takeshitaStreet: { query: 'Takeshita Street' },
    sunshine60: { query: 'Sunshine 60 Observatory' },
    animateIkebukuro: { query: 'Animate Ikebukuro Flagship Store' },
    akihabara: { query: 'Akihabara Electric Town' },
    harajukuVintage: { query: 'Cat Street Harajuku' },
    roppongiMidtown: { query: 'Tokyo Midtown' },
    dxbAirport: { query: 'Dubai International Airport Terminal 3' },
    kix: { query: 'Kansai International Airport' },
    hirakatashi: { query: 'Hirakatashi Station' },
    usj: { query: 'Universal Studios Japan' },
    'stay-candeo-hirakata': { query: 'Candeo Hotels Osaka' },
    'stay-sunplaza-hirakata': { query: 'Sun Plaza Hotel Osaka' },
    'stay-cross-hotel-osaka': { query: 'Cross Hotel Osaka' },
    'stay-the-thousand-kyoto': { query: 'The Thousand Kyoto' },
    'stay-hotel-granvia-kyoto': { query: 'Hotel Granvia Kyoto' },
    'stay-ekoin-koyasan': { query: 'Eko-in Temple Koyasan' },
    'stay-arima-grand': { query: 'Arima Grand Hotel' },
    'stay-la-suite-kobe': { query: 'Hotel La Suite Kobe Harborland' },
    'stay-mitsui-garden-otemachi': { query: 'Mitsui Garden Hotel Otemachi' },
    'stay-hotel-niwa-tokyo': { query: 'Hotel Niwa Tokyo' },
    'stay-disney-ambassador': { query: 'Disney Ambassador Hotel' },
    'stay-disneyland-hotel': { query: 'Tokyo Disneyland Hotel' },
    'stay-disney-celebration': { query: 'Tokyo Disney Celebration Hotel' },
  },
  routing: {
