...
export const DEFAULT_TRIP_TEMPLATE = {
  ...
  mapCoordinates: {
    ...
    'stay-disney-resort': [35.6329, 139.8838],
  },
  routing: {
  ...
  catalog: {
    activity: [
      ...
      },
      {
        ...
        image: 'https://www.kansai-airport.or.jp/sites/default/files/images/2025-02/1_1040_1040_EN.jpg',
        description:
      ...
      },
      {
        ...
        image: 'https://www.kansai-airport.or.jp/static/images/access/map_train_2f_en.png',
        description:
      ...
      },
      {
        ...
        image: 'https://www.osaka-info.jp/common/img/gnav/gnav_osaka_basic.jpg',
        description:
      ...
      },
      {
        ...
        label: 'Hirakata → KIX',
        coord: 'kix',
        url: 'https://www.kansai-airport.or.jp/en/access/bus',
        image: 'https://www.kansai-airport.or.jp/static/images/access/map_bus_1f_en.png',
        description:
      ...
      },
      {
        ...
        image: 'https://c.ekstatic.net/ecl/aircraft-interior/economy-class/economy-class-cabin-seats-w1280x960.jpg',
        description:
      ...
      },
      {
        ...
        image: 'https://www.abenoharukas-300.jp/en/images/mv01.jpg',
        description:
      ...
      },
      {
        ...
        image: 'https://www.usj.co.jp/company/assets/img/common/ogp.png',
        description:
      ...
      },
      {
        ...
        image: 'https://ujicha.or.jp/wp-content/themes/kyotocha/assets/images/OGP.png',
        description:
      ...
      },
      {
        ...
        coord: 'naraPark',
        url: 'https://nara-park.com/',
        image: 'https://nara-park.com/wp-content/uploads/2022/07/3-3.jpg',
        description:
      ...
      },
      {
        ...
        coord: 'okunoin',
        url: 'https://www.koyasan.or.jp/en/meguru/',
      ...
      },
      {
        ...
        image: 'https://www.yumeyakata.com/common/img/top/yukata4.jpg',
        description:
      ...
      },
      {
        ...
        image: 'https://eikando.or.jp/image/850nen.jpg',
        description:
      ...
      },
      {
        ...
        image: 'https://www.himejicastle.jp/ogp.png',
        description:
      ...
      },
      {
        ...
        image: 'https://harborland.co.jp/wpapp/wp-content/uploads/2025/03/slider01.jpg',
        description:
      ...
      },
      {
        ...
        image: 'https://lumiere-a.akamaihd.net/v1/images/disneyjp_pc0208_67de449e.png',
        description:
        ...
        bookingIds: ['book-tokyo-disney', 'book-disney-resort'],
      },
      {
      ...
      },
      {
        ...
        coord: 'shibuyaParco',
        url: 'https://www.pasela.co.jp/shop/tokyo/shibuya/',
        image: 'https://www.pasela.co.jp/images_2024r/shop/common/relation/img_shop_shibuya.webp',
        description:
      ...
      },
      {
        ...
        coord: 'takeshitaStreet',
        url: 'https://www.gotokyo.org/en/destinations/western-tokyo/harajuku-and-omotesando/index.html',
        image: 'https://www.gotokyo.org/shared/site_gotokyo_rn/images/ogp/ogp.png',
        description:
      ...
      },
      {
        ...
        coord: 'shibuyaParco',
        url: 'https://bluecave.jp/',
        image: 'https://bluecave.jp/wp-content/uploads/2025/09/buluecave1200_630.png',
        description:
    ...
    stay: [
      ...
      },
      {
        ...
        image: 'https://sunplazahotel.co.jp/en/img/top/topimg1.jpg',
        description:
      ...
      },
      {
        ...
        url: 'https://cross-osaka.orixhotelsandresorts.com/?lang=en',
      ...
      {
        id: 'stay-disney-resort',
        city: 'tokyo',
        label: 'Tokyo Disney Resort hotel stay',
        url: 'https://www.tokyodisneyresort.jp/en/hotel/',
        coord: 'stay-disney-resort',
        image: 'https://lumiere-a.akamaihd.net/v1/images/disneyjp_wp_db7f01ef.png',
        description:
          'Book an official Tokyo Disney Resort hotel to enjoy early park entry, character amenities, and easy monorail access. Choose from deluxe classics like Ambassador Hotel or value-friendly Celebration to match your crew.',
        bookingIds: ['book-disney-resort'],
      },
    ],
    booking: [
      ...
      { id: 'book-daruma', city: 'osaka', label: 'Kushikatsu Daruma (Shinsekai)', url: 'https://www.kushikatu-daruma.com/' },
      ...
      { id: 'book-tea-ceremony', city: 'kyoto', label: 'Camellia tea ceremony booking', url: 'https://tea-kyoto.com/' },
      ...
      { id: 'book-rurikoin', city: 'kyoto', label: 'Rurikō-in autumn visit info', url: 'https://rurikoin.komyoji.com/' },
      ...
      { id: 'book-teamlab-borderless', city: 'tokyo', label: 'teamLab Borderless (Azabudai Hills)', url: 'https://www.teamlab.art/e/tokyo/' },
      { id: 'book-tokyo-disney', city: 'tokyo', label: 'Tokyo Disney Resort tickets', url: 'https://www.tokyodisneyresort.jp/tdl/ticket/' },
      { id: 'book-ghibli', city: 'tokyo', label: 'Ghibli Museum via Lawson', url: 'https://www.ghibli-museum.jp/en/tickets/' },
      { id: 'book-shibuya-sky', city: 'tokyo', label: 'Shibuya SKY admission', url: 'https://www.shibuya-scramble-square.com/en/sky/' },
      { id: 'book-blue-cave', city: 'tokyo', label: 'Ao no Dokutsu (Blue Cave) info', url: 'https://bluecave.jp/' },
      ...
      { id: 'book-candeo-hirakata', city: 'osaka', label: 'Candeo Hirakata reservations', url: 'https://www.candeohotels.com/en/osaka-hirakata/' },
      { id: 'book-sunplaza-hirakata', city: 'osaka', label: 'Hirakata SunPlaza booking', url: 'https://sunplazahotel.co.jp/en/?tripla_booking_widget_open=search&type=plan' },
      { id: 'book-cross-hotel-osaka', city: 'osaka', label: 'Cross Hotel Osaka offers', url: 'https://go-ohr.reservation.jp/en/hotels/ohr-xosaka/plans' },
      ...
      { id: 'book-la-suite-kobe', city: 'kobe', label: 'La Suite Kobe reservations', url: 'https://d-reserve.jp/GSEA001F01300/GSEA001A01?hotelCode=0000002655' },
      ...
      { id: 'book-hotel-niwa-tokyo', city: 'tokyo', label: 'Hotel Niwa Tokyo offers', url: 'https://go-nomura-hotels.reservation.jp/en/hotels/niwa-tokyo/plans' },
      { id: 'book-airbnb-tokyo', city: 'tokyo', label: 'Airbnb Tokyo listings', url: 'https://www.airbnb.com/s/Tokyo--Japan/homes' },
      { id: 'book-disney-resort', city: 'tokyo', label: 'Tokyo Disney Resort hotels', url: 'https://www.tokyodisneyresort.jp/en/hotel/' },
    ],
  },
  prefill: {
    '2025-11-14': {
