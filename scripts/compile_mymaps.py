...
MANUAL_COORDS: Dict[str, Tuple[float, float]] = {
    ...
    'gu': (35.671968, 139.765359),
    'thisisshizen': (35.0086778, 135.7602067),
}
...
fieldnames = ['Name', 'Date', 'Time', 'Day', 'Friends', 'Group', 'Notes', 'Rating', 'Type', 'Website', 'Map URL', 'Weekday', 'Latitude', 'Longitude', 'Cluster']
